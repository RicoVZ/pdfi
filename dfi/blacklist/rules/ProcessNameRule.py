"""
Here rule_data should be a string that resembles a process name.
This rule will search through all processes to
...
class ProcessNameRule(Rule):
    ...
    def match_rule(self, rule_data):
        ...
        for process in self.cuckoo_report.process:
            ...
            try:
                if self.search_wildcard_regex(rule_data, name):
                    matches.append(name)
